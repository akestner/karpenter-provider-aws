...
repo_details: list[dict[str, Union[Repository, str]]] = [
  {
    'repo': github.get_repo('aws/karpenter-provider-aws'),
    'feature_label': 'feature'
  },
  {
    'repo': github.get_repo('kubernetes-sigs/karpenter'),
    'feature_label': 'kind/feature'
  }
]

for details in repo_details:
  repo = details['repo']
  feature_label = details['feature_label']
  open_issues = repo.get_issues(state='open', labels=[feature_label])
